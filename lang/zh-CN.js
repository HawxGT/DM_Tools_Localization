...
export default {
    ...
    BUILDER: {
        CARD: {
            ...
            OCCUPATION_TITLE: '职业',
            OCCUPATION_BENEFIT: '优势',

            PERK_SELECTION_TITLE: '技能选择',
            PERK_SELECTION_COST: '点数消耗',
            PERK_SELECTION_TRAIT: '特征',
            PERK_SELECTION_HOBBY: '爱好',
            PERK_SELECTION_SKILL: '技术',
            PERK_SELECTION_STAT: '特点',

            CHARACTER_DATA_TITLE: '人物数据',
            CHARACTER_DATA_ATTRIBUTES_TITLE: '属性(Attributes)',
            CHARACTER_DATA_ATTRIBUTES_AGILITY: '敏捷(Agility)',
            CHARACTER_DATA_ATTRIBUTES_CHARISMA: '魅力(Charisma)',
            CHARACTER_DATA_ATTRIBUTES_ENDURANCE: '耐力(Endurance)',
            CHARACTER_DATA_ATTRIBUTES_INTELLIGENCE: '智力(Intelligence)',
            CHARACTER_DATA_ATTRIBUTES_STRENGTH: '力量(Strength)',
            CHARACTER_DATA_SKILLS_TITLE: '技能(Skills)',
            CHARACTER_DATA_SKILLS_COOKING: '烹饪(Cooking)',
            CHARACTER_DATA_SKILLS_FARMING: '园艺(Farming)',
            CHARACTER_DATA_SKILLS_MECHANIC: '机械(Mechanic)',
            CHARACTER_DATA_SKILLS_CRAFTING: '制作(Crafting)',
            CHARACTER_DATA_SKILLS_LOCKPICKING: '撬锁(Lockpicking)',
            CHARACTER_DATA_SKILLS_MEDICAL: '医疗(Medical)',
